...
class TypoToleranceSettings(BaseModel):
    ...
    disable_on_attributes: list[str] = Field(default_factory=list, alias="disableOnAttributes")
...
class IndexSettings(BaseModel):
    ...
    filterable_attributes: list[str] = Field(default_factory=list, alias="filterableAttributes")
    sortable_attributes: list[str] = Field(default_factory=list, alias="sortableAttributes")
    ranking_rules: list[str] = Field(
        default_factory=lambda: ["words", "typo", "proximity", "attribute", "sort", "exactness"],
        alias="rankingRules",
    )
    ...
    non_separator_tokens: list[str] = Field(default_factory=list, alias="nonSeparatorTokens")
...
class IndexStats(BaseModel):
    ...
    field_distribution: dict[str, int] = Field(default_factory=dict, alias="fieldDistribution")
